<template>
    <div id="app" class="container">
        ...
        <b-alert show dismissible v-for="mensagem in this.mensagens" :key="mensagem.texto" :variant="mensagem.tipo">
            {{mensagem.texto}}
        </b-alert>
        ...
        <b-list-group>
            <b-list-group-item v-for="(usuario, id) in usuarios" :key="id">
                ...
                <p>
                    <b-button variant="warning" size="lg" @click="carregar(id)">Alterar</b-button>
        ...
        methods: {
            ...
            salvar() {
                ...
                this.$http[metodo](`/usuarios${finalUrl}`, this.usuario)
                    ...
                    this.mensagens.push({
                        texto: 'Ocorreu um problema para salvar!',
                        tipo: 'danger'
                    })
                })
            },
